 ...
 * Update URI:        https://github.com/nivobi/trustpilot-plugin-releases
 */
...
define( 'TP_PLUGIN_VERSION', '1.2.3' );
...
if ( is_admin() ) {
	...
	add_action( 'admin_menu', function() use ( $tp_settings ) {
		...
		add_menu_page(
			tp_t( 'Trustpilot Reviews', 'Trustpilot-anmeldelser' ),
			tp_t( 'Trustpilot', 'Trustpilot' ),
			'manage_options',
			'tp-reviews',
			[ 'TP_Preset_UI', 'render' ],
