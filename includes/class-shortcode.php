...
class TP_Shortcode {
    ...
    private static function render_card( object $review ): string {
        ...
        if ( (int) $review->is_verified === 1 ) {
            ...
            $verified_help_url = 'https://help.trustpilot.com/s/article/How-do-reviews-get-on-Trustpilot?language=' . tp_lang();
            $verified_html = '<a class="tp-review-verified" href="' . esc_url( $verified_help_url ) . '" target="_blank" rel="noopener noreferrer" aria-label="' . esc_attr( $verified_aria ) . '">'
